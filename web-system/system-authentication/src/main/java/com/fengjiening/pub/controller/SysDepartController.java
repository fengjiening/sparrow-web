...
import com.fengjiening.pub.model.SysDepartTreeModel;
...
//			}
	...
	public Result<SysDepart> add(@RequestBody SysDepart sysDepart, HttpServletRequest request) throws Exception {
	...
	@CacheEvict(value= {CacheConstant.SYS_DEPARTS_CACHE,CacheConstant.SYS_DEPART_IDS_CACHE}, allEntries=true)
	public Result<SysDepart> edit(@RequestBody SysDepart sysDepart, HttpServletRequest request) throws Exception {
		String username = JwtUtil.getUserNameByToken(request);
