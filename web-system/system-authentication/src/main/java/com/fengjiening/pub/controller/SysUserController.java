...
import com.fengjiening.annotation.PermissionData;
...
import com.fengjiening.pub.model.SysUserSysDepartModel;
...
import com.fengjiening.system.util.PasswordUtil;
import com.fengjiening.system.util.RedisUtil;
...
import com.fengjiening.vo.SysDepartUsersVO;
import com.fengjiening.vo.SysUserRoleVO;
...
//                json.put("avatar", item.getSysUser().getAvatar());
    ...
    public Result putRecycleBin(@RequestBody JSONObject jsonObject, HttpServletRequest request) throws Exception {
