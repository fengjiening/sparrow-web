...
import com.fengjiening.config.SparrowConfig;
import com.fengjiening.constant.CacheConstant;
import com.fengjiening.constant.CommonConstant;
import com.fengjiening.constant.SymbolConstant;
import com.fengjiening.pub.entity.SysDepart;
import com.fengjiening.pub.entity.SysRoleIndex;
import com.fengjiening.pub.entity.SysUser;
import com.fengjiening.pub.model.SysLoginModel;
import com.fengjiening.pub.service.*;
import com.fengjiening.pub.service.impl.SysBaseApiImpl;
import com.fengjiening.pub.util.RandImageUtil;
import com.fengjiening.system.util.*;
import com.fengjiening.system.util.encryption.EncryptedString;
import com.fengjiening.system.vo.LoginUser;
import com.fengjiening.utils.Md5Util;
...
public class LoginController {
	...
	public Result<JSONObject> login(@RequestBody SysLoginModel sysLoginModel){
		...
		String origin = lowerCaseCaptcha+sysLoginModel.getCheckKey()+config.getSignatureSecret();
	...
	public Result<String> randomImage(HttpServletResponse response,@PathVariable("key") String key){
		...
		try {
			...
			//update-begin-author:taoyan date:2022-9-13 for: VUEN-2245 【漏洞】发现新漏洞待处理20220906
			// 加入密钥作为混淆，避免简单的拼接，被外部利用，用户自定义该密钥即可
			String origin = lowerCaseCode+key+config.getSignatureSecret();
			String realKey = Md5Util.md5Encode(origin, "utf-8");
			//update-end-author:taoyan date:2022-9-13 for: VUEN-2245 【漏洞】发现新漏洞待处理20220906
