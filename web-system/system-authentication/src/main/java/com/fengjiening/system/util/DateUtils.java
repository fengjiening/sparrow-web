...
public class DateUtils extends PropertyEditorSupport {
    ...
    public static ThreadLocal<SimpleDateFormat> datetimeFormat1 = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        }
    };
    public static ThreadLocal<SimpleDateFormat> datetimeFormatMMddHHmm = new ThreadLocal<SimpleDateFormat>() {
        @Override
        protected SimpleDateFormat initialValue() {
            return new SimpleDateFormat("yyyy-MM-dd HH:mm");
        }
    ...
    public static String now1() {
        return datetimeFormat1.get().format(getCalendar().getTime());
    }
    /**
     * 当前时间，格式yyyyMMddHHmm
     *
     * @return 当前时间的标准形式字符串
     */
    public static String paserDatayyyyMMddHHmm(Date date) {
        return datetimeFormat1.get().format(date);
    }
    ...
    public static String now2yyyyMM() {
        return yyyyMM.get().format(getCalendar().getTime());
    }
    ...
    public static String formatyyyymmddhhmmTime() {
        return yyyymmddhhmm.get().format(getCalendar().getTime());
    }
    ...
    public static Map<String, String> getDateMap(String time) throws Exception {
