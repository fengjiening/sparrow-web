...
import com.fengjiening.constant.CacheConstant;
import com.fengjiening.constant.CommonConstant;
import com.fengjiening.pub.entity.SysPermission;
import com.fengjiening.pub.entity.SysPermissionDataRule;
import com.fengjiening.pub.mapper.SysDepartPermissionMapper;
import com.fengjiening.pub.mapper.SysDepartRolePermissionMapper;
import com.fengjiening.pub.mapper.SysPermissionMapper;
import com.fengjiening.pub.mapper.SysRolePermissionMapper;
import com.fengjiening.pub.model.TreeModel;
import com.fengjiening.pub.service.ISysPermissionDataRuleService;
import com.fengjiening.pub.service.ISysPermissionService;
...
public class SysPermissionServiceImpl extends ServiceImpl<SysPermissionMapper, SysPermission> implements ISysPermissionService {
	...
	public void deletePermissionLogical(String id) throws Exception {
		SysPermission sysPermission = this.getById(id);
		if(sysPermission==null) {
			throw new Exception("未找到菜单信息");
		}
	...
	@Override
	@CacheEvict(value = CacheConstant.SYS_DATA_PERMISSIONS_CACHE,allEntries=true)
	public void editPermission(SysPermission sysPermission) throws Exception {
