...
public class CertificateUtils {
	 ...
	 * @throws Exception
	 */
	static PrivateKey getPrivateKey(String keyStorePath, String alias, String password) throws Exception {
	 ...
	 * @throws Exception
	 */
	private static Certificate getCertificate(InputStream certificateInStream)
...
//    }
	 ...
	 * @throws Exception
	 */
	public static boolean verifySign(byte[] data, String sign, byte[] certificate) throws Exception {
		// 获得证书
